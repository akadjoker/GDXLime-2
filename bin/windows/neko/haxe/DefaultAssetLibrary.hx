...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("data/models/Bird.ms3d", "data/models/Bird.ms3d");
		...
		path.set ("data/models/cube.ms3d", "data/models/cube.ms3d");
		...
		path.set ("data/models/ninja.ms3d", "data/models/ninja.ms3d");
		...
		path.set ("data/models/t351sml.jpg", "data/models/t351sml.jpg");
