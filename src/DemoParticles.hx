 ...
 */
class DemoParticles extends Screen
{
...
var scene:SceneManager;
...

	{
		...
		var p = new BoxEmitter(80,new Vector3( -2, 0, -2), new Vector3(2, 2, 2));
	...
	
	{
		...
		var p = new SphereEmitter(60,new Vector3( 0, 0, 0), 1);
	p.setTexture(getTexture("data/Fire.png"));
	p.createFire();
	p.setPos(-4, 0, 0);
	scene.addNode(p);
	...
	
	{
		...
		var p = new CylinderEmitter(70,new Vector3(0, 1, 0), 1, new Vector3(0, 0, 0), 0.5,false);
	p.setTexture(getTexture("data/Fire.png"));
	p.createFire();
	p.setPos(8, 0, 0);
	scene.addNode(p);
		...
		var p = new RingEmitter(80,new Vector3(0, 0, 0), 2,0,0);
	p.setTexture(getTexture("data/Fire.png"));
	p.createFire();
	p.setPos(-8, 0, 0);
	scene.addNode(p);
