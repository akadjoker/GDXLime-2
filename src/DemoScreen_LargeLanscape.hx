...
var ellipse:Vector3 = new Vector3(10,18,10);
	...
	scene.addSkyBox(500, "data/skybox01");
	 ...
	 land = new MeshLargeLandScape("data/Raid.png");
	...
	l.setTexture( Gdx.Instance().getTexture("data/RaidTexture.jpg",true,true, true));
	l.setTexture(Gdx.Instance().getTexture("data/Detail_Texture.jpg", true, true, true),1);
