...
class DemoPrimitives extends Screen
{
	...
	var camera:com.gdx.scene3d.cameras.TargetCamera;
	...
	override public function show():Void 
	{
		...
		Cube.setTexture(Gdx.Instance().getTexture("data/rockwall.jpg", true));
		Cube.setPos( -4, 0, 0);
		var turn:Float = 0;
		...
		Cube2.setTexture(Gdx.Instance().getTexture("data/rockwall.jpg", true));
		Cube2.setPos(1, 2, 0);
	   ...
	   if (keyPress(Keys.P))
		...
		cone.setTexture(Gdx.Instance().getTexture("data/rockwall.jpg", true));
		...
		poinent.setTexture(Gdx.Instance().getTexture("data/rockwall.jpg", true));
			
		
		var cyl:SceneNode =scene.addSceneNode(MeshCreator.createCylinder());
	    cyl.setTexture(Gdx.Instance().getTexture("data/rockwall.jpg", true));
		
		
		var cylx:SceneNode = scene.addSceneNode(MeshCreator.createCube());
	    cylx.setPos(0, 0, -5);
		cylx.setTexture(Gdx.Instance().getTexture("data/rockwall.jpg", true));
