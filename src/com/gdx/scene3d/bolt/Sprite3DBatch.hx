...
import com.gdx.Gdx;
import com.gdx.Gdx.gl.BlendMode;
import com.gdx.Gdx.gl.Imidiatemode;
import com.gdx.Gdx.gl.material.Material;
import com.gdx.Gdx.gl.PackVertexBuffer;
import com.gdx.Gdx.gl.Texture;
import com.gdx.Gdx.gl.VertexBuffer;
...
buffer.render(Gdx.gl.TRIANGLES, currentBatchSize * 6);			
