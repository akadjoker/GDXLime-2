...
//	trace(version);
	...
	//	trace("Nume Triangles:" + numTriangles);
		...
		for (i in 0...numJoints)
		{
			 ...
			 var name = readString(file, 32);
			 var nameParent = readString(file, 32);
			 var pos:Vector3 = Vector3.zero;
			 pos.x = file.readFloat();
			 pos.y = file.readFloat();
			 pos.z = file.readFloat();
	...
	private static function readString(byteData:ByteArray, count:Int):String 
	{
        var name:String = "";
        var k:Int = 0;
        for (j in 0...count) {
