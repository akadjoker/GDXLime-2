	...
	override public function render(cam:Camera):Void
	{
	  ...
	  if (Bounding.isInFrustum(cam.frustumPlanes))
	  {
		...
		/*
		    ...
		    Gdx.gl.disableVertexAttribArray (mesh.pipline.vertexAttribute);
 	        if(mesh.pipline.normalAttribute>=0) Gdx.gl.disableVertexAttribArray (mesh.pipline.normalAttribute);	
			if(mesh.pipline.texCoord0Attribute>=0) Gdx.gl.disableVertexAttribArray (mesh.pipline.texCoord0Attribute);
			if(mesh.pipline.texCoord1Attribute>=0) Gdx.gl.disableVertexAttribArray (mesh.pipline.texCoord1Attribute);
		    if (mesh.pipline.colorAttribute >= 0) Gdx.gl.disableVertexAttribArray (mesh.pipline.colorAttribute);	
			if (mesh.pipline.bonesAttribute >= 0) Gdx.gl.disableVertexAttribArray (mesh.pipline.bonesAttribute);	
			if (mesh.pipline.wighsAttribute >= 0) Gdx.gl.disableVertexAttribArray (mesh.pipline.wighsAttribute);*/	
