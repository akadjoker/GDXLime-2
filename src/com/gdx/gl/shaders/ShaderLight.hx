...
normalAttribute= Gdx.gl.getAttribLocation (shaderProgram, "inVertexNormal");
 ...
 eyePositionIntensityUniform= Gdx.gl.getUniformLocation (shaderProgram, "eyePosition");
	
 
 
 ambientLightUniform = Gdx.gl.getUniformLocation (shaderProgram, "ambientLight");
 
colorUniform = Gdx.gl.getUniformLocation (shaderProgram, "directionalLight.base.color");
intensityUniform= Gdx.gl.getUniformLocation (shaderProgram, "directionalLight.base.intensity");
directionUniform= Gdx.gl.getUniformLocation (shaderProgram, "directionalLight.direction");
