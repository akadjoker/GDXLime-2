...
constantUniform= Gdx.gl.getUniformLocation (shaderProgram, "pointLight.atten.constant");
linearUniform= Gdx.gl.getUniformLocation (shaderProgram, "pointLight.atten.linear");
exponentUniform = Gdx.gl.getUniformLocation (shaderProgram, "pointLight.atten.exponent");

//base
colorUniform = Gdx.gl.getUniformLocation (shaderProgram, "pointLight.base.color");
intensityUniform = Gdx.gl.getUniformLocation (shaderProgram, "pointLight.base.intensity");

positionLightUniform = Gdx.gl.getUniformLocation (shaderProgram, "pointLight.position");
rangeUniform= Gdx.gl.getUniformLocation (shaderProgram, "pointLight.range");
