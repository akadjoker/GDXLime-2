...
{
	 Gdx.gl.bindBuffer(Gdx.gl.ARRAY_BUFFER, this.vertexBuffer);	
     Gdx.gl.bufferData(Gdx.gl.ARRAY_BUFFER, this.vertices , Gdx.gl.STATIC_DRAW);
	 Gdx.gl.vertexAttribPointer(shader.vertexAttribute, 3, Gdx.gl.FLOAT, false, 0, 0);
	 Gdx.gl.bindBuffer(Gdx.gl.ARRAY_BUFFER, this.colorBuffer);
	 Gdx.gl.bufferData(Gdx.gl.ARRAY_BUFFER, this.colors , Gdx.gl.STATIC_DRAW);
	 Gdx.gl.vertexAttribPointer(shader.colorAttribute, 4, Gdx.gl.FLOAT, false, 0, 0);
	 Gdx.gl.drawArrays(Gdx.gl.LINES, 0, Std.int(primitiveCount*2));			 
} 
	 ...
	 if(fidxPos >= 1)
{
     ...
     Gdx.gl.vertexAttribPointer(shader.colorAttribute, 4, Gdx.gl.FLOAT, false, 0, 0);
     Gdx.gl.drawArrays(Gdx.GLTRIANGLES, 0, Std.int(fprimitiveCount*3));			 
